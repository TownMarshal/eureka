package computer.myOtherStream.myOtherStream2;
...
public class CopyJavaDemo {
    public static void main(String[] args) throws IOException {
        ...
        */
        ...
        //根据数据源创建字符输入流对象
        BufferedReader br = new BufferedReader(new FileReader("E:\\itcast\\CopyJavaDemo01.java"));
        //根据目的地创建字符输出流对象
        PrintWriter pw = new PrintWriter(new FileWriter("E:\\itcast\\林青霞\\CopyJavaDemo01.java"),true);
