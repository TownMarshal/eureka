package ItHeiMa.myByteStream.FileOutputStreamDemo3;
...
/*
    ...
    四种方式实现复制视频，并记录每种方式复制视频的时间                我的耗时
        1:基本字节流一次读写一个字节             共耗时：64565毫秒  44880毫秒
        2:基本字节流一次读写一个字节数组          共耗时：107毫秒  97毫秒
        3:字节缓冲流一次读写一个字节             共耗时：405毫秒  148毫秒
        4:字节缓冲流一次读写一个字节数组          共耗时：60毫秒   26毫秒
 */
