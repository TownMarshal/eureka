 ...
 */
public class CollectionDemo111 {
    public static void main(String[] args) {
        ...
        */
        ...
        Stream<String> arr = Stream.of(strArray).filter(s -> Integer.parseInt(s.split(",")[1]) > 28);
        Map<String, Integer> map = arr.collect(Collectors.toMap(s -> s.split(",")[0], s -> Integer.parseInt(s.split(",")[1])));
